	...
	return (
		<main className="flex flex-col justify-evenly mx-48 mb-48 mt-10">
			<div className="flex flex-col bg-gray-800 rounded p-8 gap-5 font-sans text-white">
				...
				<div className="px-5">
					<div>
						<div className="text-2xl my-3 w-full bg-gray-600 rounded p-2">Welcome to URL Analyzer!</div>
						<p className="pl-3">
							These terms and conditions outline the rules and regulations for the use of URL Analyzer's Website,
							located at https://url-analyzer.jpbm.dev.
						</p>
						<p className="pl-3">
							By accessing this website we assume you accept these terms and conditions. Do not continue to use URL
							Analyzer if you do not agree to take all of the terms and conditions stated on this page.
						</p>
						<p className="pl-3">
					...
					<div>
						<div className="text-2xl my-3 w-full bg-gray-600 rounded p-2">Cookies</div>
						<p className="pl-3">
							We employ the use of cookies. By accessing URL Analyzer, you agreed to use cookies in agreement with the
							URL Analyzer's Privacy Policy.{' '}
						</p>
						<p className="pl-3">
					...
					<div>
						<div className="text-2xl my-3 w-full bg-gray-600 rounded p-2">License</div>
						<p className="pl-3">
							Unless otherwise stated, URL Analyzer and/or its licensors own the intellectual property rights for all
							material on URL Analyzer. All intellectual property rights are reserved. You may access this from URL
							Analyzer for your own personal use subjected to restrictions set in these terms and conditions.
						</p>
						<p className="pl-3">You must not:</p>
						<ul className="pl-3">
							<li className="pl-5">- Republish material from URL Analyzer</li>
							<li className="pl-5">- Sell, rent or sub-license material from URL Analyzer</li>
							<li className="pl-5">- Reproduce, duplicate or copy material from URL Analyzer</li>
							<li className="pl-5">- Redistribute content from URL Analyzer</li>
						</ul>
						<p className="pl-3">
						...
						<p className="pl-3">
							...
							certain areas of the website. URL Analyzer does not filter, edit, publish or review Comments prior to
							their presence on the website. Comments do not reflect the views and opinions of URL Analyzer,its agents
							and/or affiliates. Comments reflect the views and opinions of the person who post their views and
							opinions. To the extent permitted by applicable laws, URL Analyzer shall not be liable for the Comments or
							for any liability, damages or expenses caused and/or suffered as a result of any use of and/or posting of
							and/or appearance of the Comments on this website.
						</p>
						<p className="pl-3">
							URL Analyzer reserves the right to monitor all Comments and to remove any Comments which can be considered
							inappropriate, offensive or causes breach of these Terms and Conditions.
						</p>
						<p className="pl-3">You warrant and represent that:</p>
						<ul className="pl-3">
							<li className="pl-5">
						...
						<p className="pl-3">
							You hereby grant URL Analyzer a non-exclusive license to use, reproduce, edit and authorize others to use,
							reproduce and edit any of your Comments in any and all forms, formats or media.
						</p>
					</div>
					<div>
						<div className="text-2xl my-3 w-full bg-gray-600 rounded p-2">Hyperlinking to our Content</div>
						<p className="pl-3">The following organizations may link to our Website without prior written approval:</p>
						<ul className="pl-3">
							<li className="pl-5">- Government agencies;</li>
							<li className="pl-5">- Search engines;</li>
							<li className="pl-5">- News organizations;</li>
							<li className="pl-5">
						...
						<ul className="pl-3">
							<li className="pl-5">- commonly-known consumer and/or business information sources;</li>
							<li className="pl-5">- dot.com community sites;</li>
							<li className="pl-5">- associations or other groups representing charities;</li>
							<li className="pl-5">- online directory distributors;</li>
							<li className="pl-5">- internet portals;</li>
							<li className="pl-5">- accounting, law and consulting firms; and</li>
							<li className="pl-5">- educational institutions and trade associations.</li>
						</ul>
						<p className="pl-3">
							...
							absence of URL Analyzer; and (d) the link is in the context of general resource information.
						</p>
						<p className="pl-3">
						...
						<p className="pl-3">
							...
							website, you must inform us by sending an e-mail to URL Analyzer. Please include your name, your
						...
						<p className="pl-3">Approved organizations may hyperlink to our Website as follows:</p>
						<ul className="pl-3">
							<li className="pl-5">- By use of our corporate name; or</li>
							<li className="pl-5">- By use of the uniform resource locator being linked to; or</li>
							<li className="pl-5">
						...
						<p className="pl-3">
							No use of URL Analyzer's logo or other artwork will be allowed for linking absent a trademark license
							agreement.
						</p>
					</div>
					<div>
						<div className="text-2xl my-3 w-full bg-gray-600 rounded p-2">iFrames</div>
						<p className="pl-3">
					...
					<div>
						<div className="text-2xl my-3 w-full bg-gray-600 rounded p-2">Content Liability</div>
						<p className="pl-3">
					...
					<div>
						<div className="text-2xl my-3 w-full bg-gray-600 rounded p-2">Your Privacy</div>
						<p className="pl-3">Please read Privacy Policy</p>
					</div>
					<div>
						<div className="text-2xl my-3 w-full bg-gray-600 rounded p-2">Reservation of Rights</div>
						<p className="pl-3">
					...
					<div>
						<div className="text-2xl my-3 w-full bg-gray-600 rounded p-2">Removal of links from our website</div>
						<p className="pl-3">
					...
					<div>
						<div className="text-2xl my-3 w-full bg-gray-600 rounded p-2">Disclaimer</div>
						<p className="pl-3">
							To the maximum extent permitted by applicable law, we exclude all representations, warranties and
							conditions relating to our website and the use of this website. Nothing in this disclaimer will:
						</p>
						<ul className="pl-3">
							<li className="pl-5">- limit or exclude our or your liability for death or personal injury;</li>
							<li className="pl-5">
					...
					<div>
						<div className="text-2xl my-3 w-full bg-gray-600 rounded p-2">Contact:</div>
						<p className="pl-3">If you have any questions about this Disclaimer, You can contact us:</p>
						<ul className="pl-3">
							<li className="pl-5">
								- By email:
								<a href="mailto:jpedrobm0@gmail.com"> jpedrobm0@gmail.com </a>
							</li>
						</ul>
					</div>
				</div>
